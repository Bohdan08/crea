const data = [
  {
    ...
    congress: "117",
    dateIssued: "2021-03-21T12:00:00Z",
    text: `
  ...
  },
  {
    ...
    S. RES. 92
     ...
     Designating March 5, 2021, as National Speech and Debate Education 
                                     Day''.
    ...
    _______________________________________________________________________
      ...
      Mr. Grassley (for himself, Mr. Coons, Mr. Barrasso, Mr. Braun, Mrs. 
    Capito, Mr. Carper, Mr. Cramer, Mr. Crapo, Mr. Durbin, Ms. Ernst, Mrs. 
      Hyde-Smith, Mr. King, Ms. Klobuchar, and Ms. Warren) submitted the 
    ...
    Whereas it is essential for youth to learn and practice the art of communicating 
            with and without technology;
    Whereas speech and debate education offers students myriad forms of public 
            speaking through which students may develop talent and exercise unique 
            voice and character;
    Whereas speech and debate education gives students the 21st-century skills of 
            communication, critical thinking, creativity, and collaboration;
    Whereas critical analysis and effective communication allow important ideas, 
            texts, and philosophies the opportunity to flourish;
    Whereas personal, professional, and civic interactions are enhanced by the 
            ability of the participants in those interactions to listen, concur, 
            question, and dissent with reason and compassion;
    Whereas students who participate in speech and debate have chosen a challenging 
            activity that requires regular practice, dedication, and hard work;
    Whereas teachers and coaches of speech and debate devote in-school, afterschool, 
            and weekend hours to equip students with life-changing skills and 
            opportunities;
    Whereas National Speech and Debate Education Day emphasizes the lifelong impact 
            of providing people of the United States with the confidence and 
            preparation to both discern and share views;
    Whereas National Speech and Debate Education Day acknowledges that most 
            achievements, celebrations, commemorations, and pivotal moments in 
            modern history begin, end, or are crystallized with public address;
    Whereas National Speech and Debate Education Day recognizes that learning to 
            research, construct, and present an argument is integral to personal 
            advocacy, social movements, and the making of public policy;
    Whereas the National Speech & Debate Association, in conjunction with national 
            and local partners, honors and celebrates the importance of speech and 
            debate through National Speech and Debate Education Day; and
    Whereas National Speech and Debate Education Day emphasizes the importance of 
            speech and debate education and the integration of speech and debate 
            education across grade levels and disciplines: Now, therefore, be it
        Resolved, That the Senate--
                (1) designates March 5, 2021, as National Speech and 
            ...
            community and civic associations, and all people of the United 
            States to celebrate and promote National Speech and Debate 
            Education Day.
                                     &lt;all&gt;`,
  },
  //   {
  //     packageId: "BILLS-116sres902s",
  //     title:
